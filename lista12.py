...
def verbing(s):
  if len(s) >= 3: # ele vai ler o (s) e vai ver o tamanho
    if s[-3:] != 'ing': # -3 porque são as 3 ultimas letras que ele quer conferir
      s = s + 'ing' # adc no final da palavra
    else:
      s = s + 'ly' # adc no final da palavra
  return s
